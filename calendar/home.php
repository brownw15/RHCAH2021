        ...
        <div class="main has-text-white my-4" style="display:flex">   
            ...
            <div class="dropdown">
                <div class="dropdown-trigger">
                    ...
                    <span class="mx-2"> Select Child</span>
                ...
                <div class="dropdown-menu" id="dropdown-menu2" role="menu">
                    <div class="dropdown-content" name = "childMenu">
                        
                            <div class="dropdown-item">
                                <select name="childMenu">
                                <?php
                ...
                <input class="button is-primary px-2 mx-2" type="submit" value="Submit "/>
                </form>
            </div>
            
            <div class="container" class="mx-3 px-2">
            ...
            <div id="dp" class="remove-all-styles">
            </div>
