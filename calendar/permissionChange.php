			...
			else
			{
				...
				foreach ($accList as $readResult)// check if the id actually exists
				{
					if($confirm1 == $readResult['id'])
					{
						...
						//echo $confirm1;
                            $staff = "staff";
                            $stmt = $link->prepare("UPDATE account SET description = ? 
                                            WHERE  id = ?");
                            $stmt->bind_param('si',$staff, $_POST['confirm1']);
                            $stmt->execute();
							break;
					}
...
?>
	<div class="container box">
		...
		<!--<span class="error"><?php echo $NoMatchError; echo $InputError; echo $NoInputError; echo $NotExistErr; ?> </span> -->
			<div class="field">
				<label class="label">Enter ID of ACC to have permission changed</label>
				<div class="control">
			...
			<div class="field">
				<span class="error"><?php echo $NoMatchError; echo $InputError; echo $NoInputError; echo $NotExistErr; ?> </span>
				<label class="label">Re-Enter ID of Account to have permission changed</label>
				<div class="control">
